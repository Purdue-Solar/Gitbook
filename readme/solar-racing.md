...
Our design cycle is structured around the school year and the races, which occur in mid-July. A new car is designed to full detail in CAD over the course of one school year, during which there are a few design reviews. Design reviews usually take the form of zoom calls with various experts, race officials, and other guests to whom the team presents the entire car's design (whatever incomplete stage it may been in). These reviews help point out things to fix early on, as well as keeping subteams up to date with one another's work.

The following year, roughly, is allocated for manufacturing as well as assembly and testing. At the end of this second school year is when FSGP and ASC happen, so we take the newly built car to both races. However, the summer before this, there is still FSGP (with no ASC following it). Since the new car won't have been manufactured by that point, we take the car from the previous year to compete. Said previous car will have gone through ASC and will likely be in need of repairs, meaning during design year we have to balance repairing the old car with designing the new.
